...
HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HomeComponent, selectors: [["app-home"]], decls: 8, vars: 3, consts: [["data-src", "https://storage.googleapis.com/retail-site-app-engine/retail.jpeg", "uk-img", "", 1, "uk-flex", "uk-flex-center", "uk-flex-middle", "uk-background-cover", "uk-light", "uk-height-large"], [1, "uk-section", "uk-section-default"], [4, "ngIf"], [1, "uk-container"], ["uk-slider", "autoplay: true", 1, "uk-slider-container-offset"], ["tabindex", "-1", 1, "uk-position-relative", "uk-visible-toggle", "uk-light"], [1, "uk-slider-items", "uk-child-width-1-6@l", "uk-child-width-1-4@m", "uk-child-width-1-3@s", "uk-grid"], [4, "ngFor", "ngForOf"], ["href", "#", "uk-slidenav-previous", "", "uk-slider-item", "previous", 1, "uk-position-center-left-out", "uk-position-small", "uk-hidden-hover", 2, "color", "black"], ["href", "#", "uk-slidenav-next", "", "uk-slider-item", "next", 1, "uk-position-center-right-out", "uk-position-small", "uk-hidden-hover", 2, "color", "black"], [3, "product"], [1, "uk-child-width-1-6@l", "uk-child-width-1-4@m", "uk-child-width-1-3@s", "uk-grid"]], template: function HomeComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "title");
